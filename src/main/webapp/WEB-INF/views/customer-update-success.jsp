...
<head>
	...
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="5; url=${pageContext.request.contextPath}/dashboard">
	<title>Success!</title>
...
<body>
	<div class="container">
		...
		<div class="alert alert-success" role="alert">
  			...
  			<h3>Your account has been updated. Thank you!</h3>
  			<hr>
  			<h4 class="mb=0">Redirecting to the Dashboard page...</h4>
		</div>
		</section>
