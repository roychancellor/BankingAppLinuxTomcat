	...
	<div class="container">
		...
		<section>
			...
			<confirmcustomer:form modelAttribute="customer"
				action="${pageContext.request.contextPath}/confirmcustomer" method="POST">
				<div class="form-row">
				...
				<a class="btn btn-primary" href="${pageContext.request.contextPath}/newcustomer">Cancel and Fix</a>
