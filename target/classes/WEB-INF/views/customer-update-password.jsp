...
<body>
	<div class="container">
		...
		<section>
			<h1>Enter Your Password to Begin Updating Process</h1>
			<p class="error">${errorMessage}</p>
			<login:form modelAttribute="passwordform" action="${pageContext.request.contextPath}/update-login" method="POST">
				...
				<div class="form-group row">
					<div class="col-sm-4">
						<a class="btn btn-success btn-lg"
							href="${pageContext.request.contextPath}/customer-settings">Cancel Without Updating</a>
					</div>
				</div>
			</login:form>
		</section>
